# Agent Guidelines for EventSourcingExploration Web API
...
src/
├── backend/
│   ├── EventSourcingExploration.Domain/           # Core domain entities, value objects
│   │   ├── Entities/               # Base entities with soft delete
│   │   └── Result.cs               # Result pattern implementation
│   │
│   ├── EventSourcingExploration.Application/      # Application contracts
...
│   │
│   ├── EventSourcingExploration.Infrastructure/   # Implementation layer
│   │   ├── Features/
│   │   │   └── {Feature}/
...
│   │   ├── Persistence/
│   │   │   ├── EventSourcingExplorationDbContext.cs
│   │   │   ├── Extensions/         # EF helpers, query extensions
│   │   │   └── Configurations/     # Shared EF configurations
│   │   └── Logging/                # Serilog configuration
│   │
│   └── EventSourcingExploration.WebApi/           # API entry point
│       ├── Features/
│       │   └── {Feature}/
...
2. **Add DbSet** to `EventSourcingExplorationDbContext`
...
| All directories containing `EventSourcingExploration` | Renamed to new project name |
...
| `EventSourcingExplorationDbContext.cs` | EF Core DbContext with role seeding |
