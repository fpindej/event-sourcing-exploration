...
This template includes scripts to rename the project (from "EventSourcingExploration" to your desired name) and configure ports. It will also restore local .NET tools (like `dotnet-ef`).
...
│   ├── EventSourcingExploration.Application/ # Application contracts, features
│   ├── EventSourcingExploration.Infrastructure/ # Implementation (EF Core, etc.)
