...
using EventSourcingExploration.Infrastructure.Persistence.Exceptions;
using EventSourcingExploration.WebApi.Shared;

namespace EventSourcingExploration.WebApi.Middlewares;
