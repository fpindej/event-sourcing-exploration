...
using EventSourcingExploration.Infrastructure.Features.EventSourcing.Extensions;
using EventSourcingExploration.Infrastructure.Persistence.Extensions;
using EventSourcingExploration.Infrastructure.Caching.Extensions;
using EventSourcingExploration.Infrastructure.Cookies.Extensions;
using EventSourcingExploration.Infrastructure.Identity.Extensions;
using EventSourcingExploration.WebApi.Extensions;
using EventSourcingExploration.WebApi.Features.OpenApi.Extensions;
using EventSourcingExploration.WebApi.Middlewares;
using Serilog;
using LoggerConfigurationExtensions = EventSourcingExploration.Infrastructure.Logging.Extensions.LoggerConfigurationExtensions;
