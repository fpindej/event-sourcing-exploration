...
using MyProject.Application.Features.EventSourcing.Dtos;
using MyProject.Domain;
using MyProject.Domain.EventSourcing.BankAccount;

namespace MyProject.Infrastructure.Features.EventSourcing.Services;
